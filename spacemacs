...
This function should only modify configuration layer settings."
  ...
  ;; try deactivate spacemacs buffer
...
before packages are loaded."
  ...
  (setq org-capture-templates
        '(
          ("t" "Work todo"    entry (file+headline "~/org-notes/Todo.org" "Work")
           "* TODO [#A] %? %^g\n \
...
\n ")
          ("f" "Finance" plain
            (file+function "~/org-notes/Finance.org" find-month-tree)
...
(custom-set-variables
 ...
 '(org-agenda-files
   '("~/org-notes/Finance.org" "~/org-notes/Joris.org" "~/org-notes/Todo.org" "~/org-notes/Note.org" "~/org-notes/Project.org"))
 '(package-selected-packages
   '(xterm-color shell-pop multi-term eshell-z eshell-prompt-extras esh-help yasnippet-snippets yaml-mode ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package unfill toc-org symon string-inflection spaceline-all-the-icons smeargle restart-emacs rainbow-delimiters popwin persp-mode pcre2el password-generator paradox overseer orgit org-projectile org-present org-pomodoro org-mime org-download org-bullets org-brain open-junk-file neotree nameless mwim move-text magit-svn magit-gitflow macrostep lorem-ipsum link-hint indent-guide hungry-delete htmlize hl-todo highlight-parentheses highlight-numbers highlight-indentation helm-xref helm-themes helm-swoop helm-purpose helm-projectile helm-mode-manager helm-make helm-gitignore helm-git-grep helm-flx helm-descbinds helm-company helm-c-yasnippet helm-ag google-translate golden-ratio gnuplot gitignore-templates gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link fuzzy font-lock+ flycheck-pos-tip flx-ido fill-column-indicator fancy-battery eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-org evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-ediff evil-cleverparens evil-args evil-anzu eval-sexp-fu elisp-slime-nav editorconfig dumb-jump dotenv-mode doom-modeline diminish define-word counsel-projectile company-statistics company-plsense column-enforce-mode clean-aindent-mode centered-cursor-mode auto-yasnippet auto-highlight-symbol auto-compile aggressive-indent ace-window ace-link ace-jump-helm-line ac-ispell)))
(custom-set-faces
